...
(function(root, factory) {
    ...
    /**
     * test/setup.js needs the index, because it replaces the body in place; the
     * browser harness needs the function. Both come off this one scan rather than
     * a copy each, which is the whole point of this module.
     */
    function bodyOf(args) {
        var index = bodyIndexOf(args);
